...
goog.exportSymbol('proto.com.chicago.dto.PositionsRequest', null, global);
 ...
 * @constructor
 */
proto.com.chicago.dto.PositionsRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.com.chicago.dto.PositionsRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.com.chicago.dto.PositionsRequest.displayName = 'proto.com.chicago.dto.PositionsRequest';
}
 ...
 * @return {!Object}
 */
proto.com.chicago.dto.PositionsRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.com.chicago.dto.PositionsRequest.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.com.chicago.dto.PositionsRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.chicago.dto.PositionsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.com.chicago.dto.PositionsRequest}
 */
proto.com.chicago.dto.PositionsRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.com.chicago.dto.PositionsRequest;
  return proto.com.chicago.dto.PositionsRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.com.chicago.dto.PositionsRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.com.chicago.dto.PositionsRequest}
 */
proto.com.chicago.dto.PositionsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.com.chicago.dto.PositionsRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.com.chicago.dto.PositionsRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.com.chicago.dto.PositionsRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.com.chicago.dto.PositionsRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.com.chicago.dto.PositionsRequest.prototype.getOrganizationId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.com.chicago.dto.PositionsRequest.prototype.setOrganizationId = function(value) {
...
proto.com.chicago.dto.PositionsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    positions: (f = msg.getPositions()) && position_pb.Positions.toObject(includeInstance, f),
    transactionError: (f = msg.getTransactionError()) && common_pb.TransactionError.toObject(includeInstance, f)
  };
...
proto.com.chicago.dto.PositionsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new position_pb.Positions;
      reader.readMessage(value,position_pb.Positions.deserializeBinaryFromReader);
...
proto.com.chicago.dto.PositionsResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      position_pb.Positions.serializeBinaryToWriter
    );
  }
  f = message.getTransactionError();
  if (f != null) {
...
/**
 * optional Positions positions = 1;
 * @return {?proto.com.chicago.dto.Positions}
 */
proto.com.chicago.dto.PositionsResponse.prototype.getPositions = function() {
  return /** @type{?proto.com.chicago.dto.Positions} */ (
    jspb.Message.getWrapperField(this, position_pb.Positions, 1));
};


/** @param {?proto.com.chicago.dto.Positions|undefined} value */
proto.com.chicago.dto.PositionsResponse.prototype.setPositions = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};


proto.com.chicago.dto.PositionsResponse.prototype.clearPositions = function() {
 ...
 * @return {!boolean}
 */
proto.com.chicago.dto.PositionsResponse.prototype.hasPositions = function() {
  return jspb.Message.getField(this, 1) != null;
};
